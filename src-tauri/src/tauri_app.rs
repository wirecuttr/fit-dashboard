...
use crate::{
    ...
    power_zones::{load_power_zone_preferences, save_power_zone_preferences, PowerZonePreferences},
...
#[tauri::command]
fn get_power_zone_preferences(state: State<'_, AppState>) -> Result<PowerZonePreferences, String> {
